...
def generate_adversarial_example(image_tensor, epsilon=1):
    """
...
def load_image_from_path(image_path):
    """Load an image from a path and display predictions for original and adversarial versions."""
    ...
    adversarial_image_resized = resize_transform(adversarial_image)  # Resize adversarial to match original

    adversarial_prediction = predict_image(adversarial_image_resized)
    ...
    # Display the adversarial image and its prediction
